...
python train.py --model_name cnn_1d --data_name PU        --normalise_type mean-std --processing_type B_A --max_epoch 10 --data_dir /vann/data/dlb/pu --batch_size 16
python train.py --model_name cnn_2d --data_name PUCWT     --normalise_type mean-std --processing_type B_A --max_epoch 10 --data_dir /vann/data/dlb/pu --batch_size 16
python train.py --model_name cnn_2d --data_name PUSlice   --normalise_type mean-std --processing_type B_A --max_epoch 10 --data_dir /vann/data/dlb/pu --batch_size 16
python train.py --model_name cnn_1d --data_name PUFFT     --normalise_type mean-std --processing_type B_A --max_epoch 10 --data_dir /vann/data/dlb/pu --batch_size 16
python train.py --model_name cnn_2d --data_name PUSTFT    --normalise_type mean-std --processing_type B_A --max_epoch 10 --data_dir /vann/data/dlb/pu --batch_size 16

python train.py --model_name cnn_1d --data_name PU        --normalise_type mean-std --processing_type R_A --max_epoch 10 --data_dir /vann/data/dlb/pu --batch_size 16
python train.py --model_name cnn_2d --data_name PUCWT     --normalise_type mean-std --processing_type R_A --max_epoch 10 --data_dir /vann/data/dlb/pu --batch_size 16
python train.py --model_name cnn_2d --data_name PUSlice   --normalise_type mean-std --processing_type R_A --max_epoch 10 --data_dir /vann/data/dlb/pu --batch_size 16
python train.py --model_name cnn_1d --data_name PUFFT     --normalise_type mean-std --processing_type R_A --max_epoch 10 --data_dir /vann/data/dlb/pu --batch_size 16
python train.py --model_name cnn_2d --data_name PUSTFT    --normalise_type mean-std --processing_type R_A --max_epoch 10 --data_dir /vann/data/dlb/pu --batch_size 16
